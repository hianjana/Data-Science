...
df_header = pd.read_csv('C:/Users/hianj/Desktop/AMEX Hackerthon/Data_Problem2/header.csv', header=None)

df_colnames = df_header.iloc[[0]]
lst_colnames = df_colnames.values.tolist()
colnames = lst_colnames[0]

df = pd.read_csv('C:/Users/hianj/Desktop/AMEX Hackerthon/Data_Problem2/train.csv', header=None, names=colnames)
...
df_scoring = pd.read_csv('C:/Users/hianj/Desktop/AMEX Hackerthon/Data_Problem2/test.csv', header=None, names=colnames_test)
...
filename = 'C:/Users/hianj/Desktop/AMEX Hackerthon/scores_ET_final.csv'
